...
class Skater(Character):
    DESC = """
    The Skater class is agile and quick, excelling in evasion and critical strikes. They are known for their speed and ability to dodge attacks, making them hard to hit in combat.
    They also have a pretty good balance between physical attack and defense, as well as speed to outmaneuver opponents.
    """
