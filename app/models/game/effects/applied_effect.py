...
class AppliedEffect(SQLModel):
    """
    A concrete effect that has been applied to an entity.
    ...
    def apply(self, duration: int = 1) -> None:
        ...
        # The actual effect application is handled by the entity's stat calculation methods
        # This method exists for compatibility but effects are processed through entity.resolve_effects()
        pass